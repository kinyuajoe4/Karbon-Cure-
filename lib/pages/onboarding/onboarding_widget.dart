              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          await launchUrl(Uri(
                              scheme: 'mailto',
                              path: 'kinyuajoe4@gmail.com',
                              query: {
                                'subject':
                                    'Running into some problem in the Karbon Cure app.',
                                'body':
                                    'Please desribe your issue and our technical team will reach out to you.',
                              }
                                  .entries
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 670.0, 0.0, 10.0),
                      child: InkWell(
                        splashColor: Colors.transparent,
                        focusColor: Colors.transparent,
                        hoverColor: Colors.transparent,
